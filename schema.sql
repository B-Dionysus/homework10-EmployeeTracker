...
insert into role(title, salary, department_id) values("Shipping Coordinator", 30000, 2);
insert into role(title, salary, department_id) values("Salesperson", 30000, 1);
insert into role(title, salary, department_id) values("Intern", 10000, 1);
insert into role(title, salary, department_id) values("Intern", 10000, 2);